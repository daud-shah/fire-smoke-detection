...
# model = YOLO(r"D:\MY WORK\Project\fire-smoke-detection\best.pt")  # Assumes best.pt is in D:\MY WORK\Project\fire-smoke-detection

# # Alarm sound file
# ALARM_SOUND = r"D:\MY WORK\Project\fire-smoke-detection\videoplayback.m4a"  # Assumes alarm.wav is in D:\MY WORK\Project\fire-smoke-detection
...
#     # Perform inference
#     results = model(frame, conf=0.25, iou=0.25, device='cpu')  # Use CPU

#     # Flag to track detection
...
#     # Trigger alarm and visual alert if fire or smoke is detected
#     if fire_or_smoke_detected:
#         print("ALERT: Fire or Smoke Detected!")
#         cv2.putText(frame, "ALERT: FIRE/SMOKE DETECTED!", (50, 50), 
...
class FireDetectionApp(QMainWindow):
    def __init__(self):
        ...
        self.model = YOLO("best.pt")  # Update path
        self.alarm_sound = "alarm.wav"  # Update path
        self.cap = None
    ...
    def start_recording(self):
        ...
        self.out = cv2.VideoWriter(self.save_path, fourcc, fps if fps > 0 else 20.0, 
                                  (width, height))
